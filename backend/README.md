...
## Project Structure
    ...
    ├── testasadsdswcs_dev_46389  # Django project configurations
...
1. Clone this repo and `cd testasadsdswcs_dev_46389`
...
2. Clone this repo and `cd testasadsdswcs_dev_46389`
